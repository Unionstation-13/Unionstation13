...
#define HUMAN_ONLY_JOBS /datum/job/rd, /datum/job/scientist, /datum/job/senior_scientist, /datum/job/cmo, /datum/job/doctor, /datum/job/senior_doctor, /datum/job/junior_doctor, /datum/job/chemist, /datum/job/pathfinder, /datum/job/explorer, /datum/job/captain
	species_to_job_blacklist = list(
		...
		/singleton/species/nabber = list(HUMAN_ONLY_JOBS),
		/singleton/species/skrell = list(HUMAN_ONLY_JOBS)  	//Other jobs unavailable via branch restrictions,
	)
#undef HUMAN_ONLY_JOBS
	...
	allowed_jobs = list(
		...
		/datum/job/engineer, /datum/job/roboticist, /datum/job/engineer_trainee,
		/datum/job/officer, /datum/job/warden, /datum/job/detective, /datum/job/sec_physician,
