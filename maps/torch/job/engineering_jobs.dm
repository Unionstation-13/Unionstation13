...
/datum/job/engineer/get_description_blurb()
	return "You are a Technician, and you work for Nitros Engineering as a multipurpose technician. You are a jack of many trades, although not excellent at any specific one."
