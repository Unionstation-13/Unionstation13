...
/datum/gear/award/solgov_award_civilian/sapientarian
	...
	description = "A copper medal awarded by the UGN for individuals who have contributed substantially to sapient rights or fostered greater brotherhood between sapient species. It is embossed with a date, text, and an image of famous Expeditionary Corps sapientarian, Samuel Carr."
...
/datum/gear/award/solgov_award_military
	...
	description = "A bronze heart awarded by the UGN for members of the UGN Defense Forces who suffer injury or death in a combat zone."
...
/datum/gear/award/solgov_award_military/home_guarrd
	...
	description = "A bronze medal awarded by the UGN for members of the UGN Defense Forces who have helped defend the border regions of Sol."
...
/datum/gear/award/solgov_award_military/iron_star
	...
	description = "An iron star awarded by the UGN to members of the UGN Defense Forces who have performed acts of 'meritorious achievements or service.'"
...
/datum/gear/award/solgov_award_military/medical
	...
	description = "An electrum heart medal with a Staff of Hermes and sanguine cross, awarded by the UGN to individuals who have served as medical personnel in an active combat zone."
...
/datum/gear/award/solgov_award_military/armed_forces
	...
	description = "A brass medal awarded by the UGN for members of the UGN Defense Forces who have performed distinguishing acts outside of direct combat with an enemy."
...
/datum/gear/award/solgov_award_military/silver_sword
	...
	description = "A silver medal awarded by the UGN for members of the UGN Defense Forces who have demonstrated exceptional valor in combat."
...
/datum/gear/award/solgov_award_military/service_cross
	...
	description = "A copper cross awarded by the UGN for members of the UGN Defense Forces who have performed acts of incredible valor against an enemy of Sol."
...
/datum/gear/award/solgov_award_military/medal_of_honor
	...
	description = "An ornate golden medal awarded and conferred by the UGN Secretary-General to members of the UGN Defense Forces who have committed acts of 'conspicuous gallantry beyond the call of duty.'"
...
/datum/gear/award/solgov_award_ribbons
	...
	description = "A military ribbon awarded to members of the UGN Defense Forces for good marksmanship scores in training. Common in the days of energy weapons."
...
/datum/gear/award/solgov_award_ribbons/peace
	...
	description = "A military ribbon awarded to members of the UGN Defense Forces for service during a peacekeeping operation."
...
/datum/gear/award/solgov_award_ribbons/frontier
	...
	description = "A military ribbon awarded to members of the UGN Defense Forces for service along the frontier."
...
/datum/gear/award/solgov_award_ribbons/instructor
	...
	description = "A military ribbon awarded to members of the UGN Defense Forces for service as an instructor or professional development agent."
...
/datum/gear/award/solgov_award_ribbons/combat
	...
	description = "A military ribbon awarded to members of the UGN Defense Forces for serving in active combat. Colloquially known as 'blood gold.'"
...
/datum/gear/award/solgov_award_ribbons/gaiaconflict
	...
	description = "A military ribbon awarded to members of the UGN Defense Forces for serving in the Gaia Conflict."
...
/datum/gear/award/solgov_award_ribbons/distinguished_unit
	...
	description = "A military ribbon awarded to members of the UGN Defense Forces for service as part of a unit that has performed a distinguishing act of valor."
