...
/datum/computer_file/report/recipient/exp/fauna/generate_fields()
	..()
	add_field(/datum/report_field/text_label/header, "UGN Titen Expeditions")
	...
	add_field(/datum/report_field/text_label/instruction, "On completion of this form and form approval, the Chief Science Officer should fax the form to both the Human Resources Manager and the Commanding Officer, as well as keep a copy on file in their Office alongside other mission reports.")
